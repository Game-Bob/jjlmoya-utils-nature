...
const UTILITY_ASSET_ROOT = "/_utilities/nature";
...
export const getUtilityOgImage = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/nature/images/${englishSlug}.webp`);

export const getUtilityCssPath = (englishSlug: string): string =>
    withAssetVersion(`/_utilities/nature/styles/${englishSlug}.css`);

export const CATEGORY_OG_IMAGE = getUtilityOgImage("nature");
